...
def main():
    ...
    urdf_path = "/home/gyh/Workspace/lerobot/src/lerobot/model/acone/urdf/acone.urdf"
    ...
    try:
        ...
        with mujoco.viewer.launch_passive(model, data) as viewer:
            ...
            while viewer.is_running():
                ...
                if current_time - prev_time > control_update_interval:
                    if control_mode == "joint_pos":
                        ...
                        try:
                            ...
                            with open('/home/gyh/Workspace/lerobot/src/lerobot/model/kinematics_log.txt', 'a') as log_file:
                ...
                with open('/home/gyh/Workspace/lerobot/src/lerobot/model/kinematics_log.txt', 'a') as log_file:
                    log_file.write(f"L2 norm of current joint pos: {l2_norm_current:.6f}, L2 norm of ctrl: {l2_norm_ctrl:.6f}, Diff norm: {diff_norm:.6f}")
